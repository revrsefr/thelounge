...
<html lang="en">
        ...
        <body class="<%- public ? " public" : "" %>" data-transports="<%- JSON.stringify(transports) %>">
                ...
                <div id="loading">
                        <div class="window">
                                <div id="loading-status-container">
                                        <img src="img/irc4fun-logo.png" class="logo" alt="IRC4Fun" width="256" height="170" style="object-fit:contain">
                                        <img src="img/irc4fun-logo.png" class="logo-inverted" alt="IRC4Fun" width="256" height="170" style="object-fit:contain">
                ...
                <script src="js/avatars.js?v=<%- cacheBust %>"></script>
                <script src="js/colors.js?v=<%- cacheBust %>"></script>
        </body>
</html>
